...
HomeBanners = {
	images = { "home/Blade_Dancer_Banner.jpg", "home/banner_bogwurm.png", "home/banner_emeraldraven.png", "home/banner_dandelion.png", "home/banner_ebonytiger.png", "home/banner_floatingaugur.png", "home/banner_ghostblade.png" },
	delay = 3
}
...
GameStore.Categories = {
	...
	-- Cosmetics ~ Mounts
	{
		...
		offers = {
			...
			
			{
				...
				price = 850,
				id = 224,
				description = "Dawnbringer Pegasus Mount",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
				...
				price = 850,
				id = 225,
				description = "Skybreaker Pegasus Mount",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
				...
				price = 850,
				id = 226,
				description = "Wrathfire Pegasus Mount",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
				...
				price = 950,
				id = 229,
				description = "Glacier Wyrm Mount",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},			
...

		    {
				...
				price = 950,
				id = 230,
				description = "Crimson Fang Mount",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},			
	...
	{
				icons = { "Outfit_Celestial_Male_Addon_3.png", "Outfit_Celestial_Female_Addon_3.png" },
				name = "Full Celestial Avenger Outfit",
				price = 700,
				sexId = { female = 1726, male = 1725 },
				addon = 3,
				description = "Full Celestial Avenger Outfit",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
									...
									{
				icons = { "Outfit_BladeDancer_Male_Addon_3.png", "Outfit_BladeDancer_Female_Addon_3.png" },
				name = "Full Blade Dancer Outfit",
				price = 700,
				sexId = { female = 1746, male = 1745 },
				addon = 3,
				description = "Full Blade Bancer Outfit",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
				...
				addon = 3,
				description = "Full Beekeeper Outfit",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
				home = true,
			},
...

	{
		...
		offers = {
          ...
          itemtype = 3246,
          count = 1, 
          description = "(Arm:8, magic level +2, protection all +3%, speed +40). It can only be wielded properly by knights, paladins, sorcerers and druids of level 8 or higher. Imbuements: (Empty Slot).\n HP +50 in 2seg - MANA +50 in 2seg.",
          ...
          itemtype = 9803,
          count = 1, 
          description = "(speed +10) (protection all +3%, speed +10). It can only be wielded properly by players of level 8 or higher. It weighs 4.20 oz.\n HP +5 in 1seg - MANA +3 in 1seg.",
          type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		  		  		  movable = true,
			},
          ...
          itemtype = 10342,
          count = 1, 
          description = "(speed +20) that is brand-new (protection physical +5%, lifedrain +5%, death +5%, speed +20). It can only be wielded properly by knights, paladins, druids and sorcerers of level 8 or higher",
          type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		  		  		  movable = true,
			},
										...
										{			
				  icons = { "49713.png" },
          name = "Magic Level Ring",
          price = 450,
          itemtype = 49713,
          count = 1, 
          description = "(magic level +10, protection all +5%). It can only be wielded properly by druids and sorcerers of level 8 or higher. It weighs 0.80 oz.",
          type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		  		  		  movable = true,
			},
          ...
          itemtype = 49714,
          count = 1, 
          description = "(club fighting +10, sword fighting +10, axe fighting +10, distance fighting +10, protection all +5%). It can only be wielded properly by players of level 8 or higher.",
          type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		  		  		  movable = true,
			},
...
{			
				  icons = { "49717.png" },
          name = "Ice And Fire Backpack",
          price = 698,
          itemtype = 49717,
          count = 1, 
          description = "(Vol:38) (protection fire +5%, protection ice +5%, speed +25). It weighs 1.20 oz. HP/Mana: 10 in 1 seg.",
          type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		  		  		  movable = true,
						  home = true,
			},
...
{			
          ...
          itemtype = 49706,
          count = 1, 
          description = "(Vol:38) (protection all +6%, speed +20). It weighs 1.20 oz. HP/Mana: 15 in 1 seg.",
          type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		  		  		  movable = true,
						  home = true,
			},
...
{			
				  icons = { "49712.png" },
          name = "Play Otserver 1 Year Backpack",
          price = 398,
          itemtype = 49712,
          count = 1, 
          description = "(Vol:38) (protection all +5%, speed +20). It weighs 1.20 oz. HP/Mana: 15 in 1 seg.",
          type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		  		  		  movable = true,
			},
...
{			
				  icons = { "49707.png" },
          name = "Play Otserver Backpack",
          price = 350,
          itemtype = 49707,
          count = 1, 
          description = "(Vol:38) (protection energy +5%, speed +15). It weighs 1.20 oz. HP+Mana 13 in 1 seg. Protect Energy +5",
          type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		  	movable = true,
			home = true,
			},
          ...
          itemtype = 49710,
          count = 1, 
          description = "(Vol:36) (protection fire +5%, speed +15). It weighs 1.20 oz. HP+Mana 13 in 1 seg.",
          type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		  		  		  movable = true,
			},
		...
		{			
          ...
          itemtype = 49709,
          count = 1, 
          description = "(Vol:34) (protection lifedrain +3%, speed +15). It weighs 1.20 oz. HP+Mana 9 in 1 seg. Protect Death +5",
          type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		  		  		  movable = true,
			},
          ...
          itemtype = 49708,
          count = 1, 
          description = "(Vol:34) (protection lifedrain +3%, speed +15). It weighs 1.20 oz. HP+Mana 8 in 1 seg.",
          type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		  		  		  movable = true,
			},
          ...
          itemtype = 49716,
          count = 1, 
          description = "(Vol:38) (protection energy +6%, speed +25). It weighs 1.20 oz. HP+Mana 13 in 1 seg.",
          type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		  		  		  movable = true,
			},
		...
		offers = {
          ...
          itemtype = 44179,
          count = 1, 
          description = "Using this potion your stamina will be completely filled.",
          type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		  		  		  movable = true,
			},
		...
		{			
          ...
          type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
					...
					{			
			icons = { "33313.gif" },
          name = "Teleport Cube Bosses",
          price = 140,
          itemtype = 33313,
          count = 1, 
          description = "Used to teleport to bosses",
          type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		  		  		  movable = true,
				},
					...
					{			
			icons = { "37338.gif" },
          name = "Remove Red Skull",
          price = 150,
          itemtype = 37338,
          count = 1, 
          description = "Remove Red Skull",
          type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		  		  		  movable = true,
				},
...
{			
				  icons = { "49719.png" },
          name = "Prey Wildcard Item",
          price = 700,
          itemtype = 49719,
          count = 50, 
          description = "A mystical item that grants you a Prey Wildcard when used.",
          type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE,
		  		  		  movable = true,
			},	
			{			
...
{			
          ...
          itemtype = 49698,
          count = 1, 
          description = "Use to Task System",
          type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		  		  		  movable = false,
						  home = true,
			},
...
{			
          ...
          itemtype = 49699,
          count = 1, 
          description = "A magical portable forge that allows you to craft and enhance items on the go.",
          type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		  		  		  movable = false,
						  				home = true,
			},
...
{			
				  icons = { "49718.png" },
          name = "Random Outfit Chest",
          price = 598,
          itemtype = 49718,
          count = 1, 
          description = "<i>Purchase a Random Outfit Chest and receive the chance to gain one of the following outfits!</i>\n\n{character}\n{info} You can open this chest for a random outfit.\n{info} The available outfits are:\nCitizen\nHunter\nMage\nKnight\nNobleman\nSummoner\nWarrior\nBarbarian\nDruid\nWizard\nOriental\nPirate\nAssassin\nBeggar\nShaman\nNorseman\nNightmare\nJester\nBrotherhood\nDemon Hunter\nYalaharian\nNewly Wed\nWarmaster\nWayfarer",
          type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		  		  		  movable = true,
						  				home = true,
			},					
...
{			
				  icons = { "49700.png" },
          name = "Trade Seller Portable",
          price = 528,
          itemtype = 49700,
          count = 1, 
          description = "A magical portable device that allows you to sell loot from your gold pouch directly to the vendor.",
          type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		  		  		  movable = false,
						  home = true,
			},	
...
{			
				  icons = { "49701.png" },
          name = "Auto Bank Portable",
          price = 728,
          itemtype = 49701,
          count = 1, 
          description = "Use this item to automatically transfer money to your bank",
          type = GameStore.OfferTypes.OFFER_TYPE_ITEM,
		  		  		  movable = false,
						  				home = true,
			},	
